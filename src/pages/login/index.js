        ...
        return (
            <div className={styles.container}>
                ...
                <div className={styles.guest}>
                    <input type="text" value={this._placeHolder()} onKeyUp={this._onKeyUp.bind(this)} onChange={this.changeGuestName.bind(this)} onFocus={this._onFocus.bind(this)} onBlur={this._onBlur.bind(this)}/>
                    <button type="button" onClick={this._onClick.bind(this)}><img src={enter}/></button>
                </div>
            </div>
        )
    }
